...
export class Chart {
  ...
  drawEchart(points: { points: any }, markers: {}[]) {
    ...
    let option = {
      ...
      grid: {
        left: '15%',  // Ajuste da margem esquerda para centralizar o eixo y
        right: '15%', // Ajuste da margem direita para centralizar o conteúdo
        containLabel: true,
      },
      tooltip: {
        trigger: "axis",
      ...
      yAxis: {
        ...
        nameTextStyle: {
          fontWeight: "bold",
          align: "center", // Alinha o nome do eixo ao centro
        },
